...
autocmd BufEnter,BufNewFile *.h,*.hpp,*.H,*.c,*.cc,*.cpp,*.C,*.cxx,*.l,*.y map <F1> :!man -a <cword><CR><CR>
autocmd BufEnter,BufNewFile *.h,*.hpp,*.H,*.c,*.cc,*.cpp,*.C,*.cxx*,.l,*.y map <F4> :!ctags -R --c++-kinds=+pcfmnt --fields=+iaSz --extra=+q .<CR>
autocmd BufEnter,BufNewFile *.h,*.hpp,*.H,*.c,*.cc,*.cpp,*.C,*.cxx,*.l,*.y set tags+=$HOME/.vim/cpp.tags
...
"
autocmd BufEnter,BufNewFile *.h,*.hpp,*.H,*.c,*.cc,*.cpp,*.cxx,*.rb imap <C-A> <ESC>:A<CR>
autocmd BufEnter,BufNewFile *.h,*.hpp,*.H,*.c,*.cc,*.cpp,*.cxx,*.rb map <C-A> :A<CR>
